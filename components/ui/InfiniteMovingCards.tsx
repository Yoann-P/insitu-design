  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[90vw] max-w-full relative rounded-2xl border-2 border-blue-500 flex-shrink-0 px-8 py-6 md:w-[450px]"
            style={{
              //   background:
            ...
            <blockquote>
              ...
              <div className="relative z-20 mt-6 flex items-end justify-between">
                ...
                <div className="flex flex-col gap-1">
                  <span className="text-lg leading-[1.6] text-black font-bold">
                    {item.name}
                  </span>
